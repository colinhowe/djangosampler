...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('djangosampler_sample', 'cre', 'created_dt')

        db.rename_column('djangosampler_query', 'cre', 'created_dt')

        db.rename_column('djangosampler_stack', 'cre', 'created_dt')


    def backwards(self, orm):
        
        db.rename_column('djangosampler_sample', 'created_dt', 'cre')

        db.rename_column('djangosampler_query', 'created_dt', 'cre')

        db.rename_column('djangosampler_stack', 'created_dt', 'cre')
